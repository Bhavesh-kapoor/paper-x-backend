...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="page-header">
        <h4 class="page-title">
            <i class="icon-base ti tabler-brand me-2" style="color: #667eea;"></i>All Brands
        </h4>
    ...
    <div class="card filters-card">
        ...
        <div class="collapse show" id="filtersCollapse">
            <div class="filters-body">
                <form method="GET" action="{{ route('admin.brands') }}" id="filterForm" class="row g-3">
                    <div class="col-md-3">
                        <div class="filter-group">
                            <label><i class="icon-base ti tabler-search me-1"></i>Search</label>
                            <input type="text" name="search" id="search" class="filter-input" placeholder="Name, Company, Email, Mobile..." value="{{ request('search') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="filter-group">
                    ...
                    <div class="col-md-2">
                        <div class="filter-group">
                            <label><i class="icon-base ti tabler-tag me-1"></i>Type</label>
                            <select name="type" id="type" class="filter-input">
                                <option value="">All Types</option>
                                <option value="mill" {{ request('type') == 'mill' ? 'selected' : '' }}>Mill Brand</option>
                                <option value="user" {{ request('type') == 'user' ? 'selected' : '' }}>User Brand</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
    ...
    <div class="card brands-table-card">
        <div class="card-header">
            <h5>
                ...
                Brand Management
                <span class="badge bg-light text-dark ms-2">{{ $brands->total() }} Total</span>
            </h5>
        </div>
        <div class="card-body p-0">
            <div class="table-container" id="brandsTableContainer">
                <div class="loading-overlay" id="loadingOverlay" style="display: none;">
                    <div class="spinner"></div>
                </div>
                @include('admin.management.brands-table', ['brands' => $brands])
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const filterInputs = ['status', 'profile_complete', 'type', 'city', 'date_from', 'date_to'];
    ...
    function loadBrands(url = null) {
        ...
        .then(data => {
            ...
            brandsTableContainer.innerHTML = data.html;
            
            // Update total count in header
            const totalBadge = document.querySelector('.brands-table-card .card-header .badge');
            if (totalBadge) {
        ...
        .catch(error => {
            ...
            alert('An error occurred while loading brands. Please try again.');
        })
        .finally(() => {
            // Hide loading
