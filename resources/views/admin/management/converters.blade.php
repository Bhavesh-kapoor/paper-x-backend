...
<style>
    ...
    .converters-table-card .card-header {
    ...
    .converters-table-card .card-header h5 {
        color: #ffffff;
        font-weight: 600;
        margin: 0;
        display: flex;
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold" style="color: #212529;">
            <i class="icon-base ti tabler-users me-2"></i>All Converters
        </h4>
    ...
    <!-- Table Card -->
    <div class="card converters-table-card">
        ...
        <div class="results-info" id="resultsInfo">
            Showing {{ $converters->firstItem() ?? 0 }} to {{ $converters->lastItem() ?? 0 }} of {{ $converters->total() }} results
        </div>
        <div class="card-body position-relative" id="tableContainer">
            <div class="table-responsive">
                @include('admin.management.converters-table', ['converters' => $converters])
            </div>
        </div>
    </div>
</div>
...
function applyFilters() {
    ...
    fetch(`{{ route('admin.converters') }}?${params.toString()}`, {
        headers: {
