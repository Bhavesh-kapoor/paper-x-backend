...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="page-header">
        <h4 class="page-title">
            <i class="icon-base ti tabler-users me-2" style="color: #667eea;"></i>All Users
        </h4>
    ...
    <div class="card filters-card">
        ...
        <div class="collapse show" id="filtersCollapse">
            <div class="filters-body">
                <form method="GET" action="{{ route('admin.users') }}" id="filterForm" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <div class="filter-group">
                            <label><i class="icon-base ti tabler-user me-1"></i>Role</label>
                    ...
                    <div class="col-md-2">
                        <div class="filter-group">
                            <label><i class="icon-base ti tabler-check me-1"></i>Status</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const filterInputs = ['role', 'status', 'city', 'date_from', 'date_to'];
    ...
    clearFiltersBtn.addEventListener('click', function() {
        ...
        window.history.pushState({}, '', '{{ route("admin.users") }}');
        loadUsers();
    });
