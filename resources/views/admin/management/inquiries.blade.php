...
<style>
    ...
    .inquiries-table-card .card-header {
    ...
    .inquiries-table-card .card-header h5 {
        color: #ffffff;
        font-weight: 600;
        margin: 0;
        display: flex;
...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="page-title">
            <i class="icon-base ti tabler-file-text me-2"></i>All Inquiries
        </h4>
            ...
            <form id="filterForm">
                <div class="filter-row">
                    <div class="filter-group">
                        <label>Search</label>
                        <input type="text" name="search" id="search" placeholder="Search by title, description, location..." value="{{ request('search') }}">
                    </div>
                    <div class="filter-group">
                        <label>Type</label>
                    ...
                    <div class="filter-group">
                        ...
                        <select name="intent" id="intent">
                            ...
                            @foreach($intents as $intent)
                                <option value="{{ $intent }}" {{ request('intent') == $intent ? 'selected' : '' }}>{{ $intent }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="filter-group">
                    ...
                    <div class="filter-group">
                        ...
                        <select name="urgency" id="urgency">
                            ...
                            @foreach($urgencies as $urgency)
                                <option value="{{ $urgency }}" {{ request('urgency') == $urgency ? 'selected' : '' }}>{{ ucfirst($urgency) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="filter-group">
                        <label>Location</label>
                        <input type="text" name="location" id="location" list="locations" placeholder="Enter location" value="{{ request('location') }}">
    ...
    <div class="card inquiries-table-card">
        ...
        <div class="card-body position-relative" id="tableContainer">
            <div class="table-responsive">
                @include('admin.management.inquiries-table', ['inquiries' => $inquiries])
            </div>
        </div>
    </div>
</div>
